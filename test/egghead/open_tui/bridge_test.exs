defmodule Egghead.OpenTUI.BridgeTest do
  ...
  `setup_terminal/1` or `draw_hello/4` — those write escape sequences
  to stdout and would corrupt test output. We verify only that:
  ...
  The visual end-to-end check is `mix tui.records`, run by hand.
  """
